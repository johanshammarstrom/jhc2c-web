...
// Uppdaterad med Cubic Bezier för att fixa TypeScript-felet i Amplify
const fadeInUp = {
            ...
            <header className="py-16 md:py-24 px-6 max-w-7xl mx-auto">
                <div className="max-w-4xl">
                    <motion.div
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 1 }}
                        className="text-blue-500 font-bold tracking-[0.3em] uppercase mb-4 text-sm"
                    >
            ...
            <section className="py-12 px-6 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16">
                ...
                <div className="lg:col-span-7 space-y-12">
                    <motion.h2
                        ...
                        className="text-2xl font-bold text-white uppercase tracking-tighter flex items-center gap-3"
                    >
                    ...
                    <div className="space-y-6">
                        <StepCard
                            ...
                            icon={<Gauge size={24} />}
                            color="text-blue-400"
                            title="Inform - Synlighet & Allokering"
                            desc="Vi etablerar granulär kostnadsallokering genom avancerad tagging. Sluta gissa – få full koll på kostnader per tjänst, miljö och affärsenhet."
                        />
                        <StepCard
                            index={2}
                            icon={<TrendingDown size={24} />}
                            color="text-green-400"
                            title="Optimize - Rightsizing & Commitments"
                            desc="Genom djupanalys av nyttjandemönster optimerar vi era resurser. Vi navigerar komplexiteten i Savings Plans och Reserved Instances åt er."
                        />
                        <StepCard
                            index={3}
                            icon={<Target size={24} />}
                            color="text-purple-400"
                            title="Operate - Unit Economics"
                            desc="Vi integrerar FinOps i er existerande Governance-modell. Fokus flyttas från 'total spend' till 'enhetskostnad' för ökad lönsamhet."
                        />
                    </div>
                </div>
                ...
                >
                    <div className="bg-gradient-to-br from-slate-900 to-[#0a1122] border border-slate-800 p-12 rounded-[2.5rem] relative overflow-hidden group">
                        ...
                        <p className="text-blue-400 font-bold uppercase tracking-[0.2em] text-xs mb-8">
                            Typisk kostnadsreduktion
                        </p>

                        <p className="text-slate-400 italic text-lg leading-relaxed border-l-2 border-blue-500/30 pl-6">
                            "FinOps handlar inte om att spara pengar. Det handlar om att tjäna pengar genom att fatta smartare beslut i molnet."
                        </p>
                    </div>

                    <div className="grid grid-cols-1 gap-4 text-xs font-mono uppercase tracking-widest text-slate-500">
                        <div className="flex items-center gap-2">
                            <div className="w-1.5 h-1.5 rounded-full bg-blue-500" /> Tagging Strategies
                        </div>
                        <div className="flex items-center gap-2">
                            <div className="w-1.5 h-1.5 rounded-full bg-blue-500" /> Anomalies Detection
                        </div>
                        <div className="flex items-center gap-2">
                            <div className="w-1.5 h-1.5 rounded-full bg-blue-500" /> Unit Cost Analysis
                        </div>
                    </div>
                </motion.div>
            </section>
...
function StepCard({ index, icon, color, title, desc }: { index: number, icon: any, color: string, title: string, desc: string }) {
    return (
        ...
        >
            <div className={`bg-slate-800/50 p-4 rounded-xl h-fit ${color} group-hover:scale-110 transition-transform`}>
                {icon}
            </div>
            <div>
